...
Route::post('/apirequest', 'DuitkuController@apirequest')->name('apirequest');
Route::post('/response', 'DuitkuController@response');
Route::post('/store', 'DuitkuController@store');
Route::get('/callback', 'DuitkuController@callback')->name('callback');
Route::get('/paymentconfirm', 'DuitkuController@paymentconfirm')->name('paymentconfirm');
